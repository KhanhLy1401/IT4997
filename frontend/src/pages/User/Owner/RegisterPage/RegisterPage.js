...
//         const response = await axios.post(`${API_URL}/user/request-owner`,  {
//             _id,
//             email,
//             address,
//             citizen_id,
...
//         if(response.data.message=="Bạn đã gửi yêu  cầu rồi"){ alert("Bạn đã gửi yêu cầu rồi. Chờ phê duyệt"); navigate("/");  return;} 
//         if(response.data.message=="") {alert("Bạn đã là chủ xe"); navigate("/"); return;};
